...
namespace ConcesionaroCarros.Db
{
    public class EmpleadosDbService
    {
        ...
        public Empleado ObtenerPorCorreo(string correo)
        {
            ...
            using (var cmd = conn.CreateCommand())
            {
                cmd.CommandText = "SELECT * FROM Empleados WHERE Correo=$c";
                ...
                using (var r = cmd.ExecuteReader())
                {
                    ...
                    return new Empleado
                    {
                        ...
                        Cargo = r.IsDBNull(5) ? "" : r.GetString(5),
                        Cedula = r.IsDBNull(8) ? "" : r.GetString(8),
                        Ciudad = r.IsDBNull(9) ? "" : r.GetString(9),
                        Departamento = r.IsDBNull(10) ? "" : r.GetString(10)
                    };
                }
            }
        }
