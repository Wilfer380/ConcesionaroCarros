...
namespace ConcesionaroCarros.ViewModels
{
    public class AdminRegisterViewModel : BaseViewModel
    {
        ...
        private void RegistrarAdmin()
        {
            ...
            var empleadosDb = new EmpleadosDbService();
            ...
            try
            {
                ...
                if (existente == null)
                {
                    ...
                    empleadosDb.Insertar(new Empleado
                    {
                        Nombres = nombres,
                        Apellidos = apellidos,
                        Correo = Correo,
                ...
                else
                {
                    ...
                    var emp = empleadosDb.ObtenerPorCorreo(Correo);
                    if (emp == null)
                    {
                        empleadosDb.Insertar(new Empleado
                        {
                    ...
                    else
                    {
                        ...
                        emp.Cargo = rolSeleccionado;
                        empleadosDb.Actualizar(emp);
                    }
                }
